...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++",
        "name": "_spherical_geometry",
        "sources": [
            "_spherical_geometry.pyx"
        ]
    },
    "module_name": "_spherical_geometry"
}
END: Cython Metadata */
...
#define __PYX_HAVE___spherical_geometry
#define __PYX_HAVE_API___spherical_geometry
/* Early includes */
#include <math.h>
#include "ios"
#include "new"
...
/* Module declarations from '_math' */
static double (*__pyx_f_5_math_radians)(double); /*proto*/
static double (*__pyx_f_5_math_degrees)(double); /*proto*/
static void (*__pyx_f_5_math_cross_product_3d)(double *, double *, double *); /*proto*/
static double (*__pyx_f_5_math_norm_3d)(double *); /*proto*/

/* Module declarations from '_spherical_geometry' */
static double __pyx_v_19_spherical_geometry_TWOPI;
static void __pyx_f_19_spherical_geometry_cartesian_coordinates(double *, double *); /*proto*/
static void __pyx_f_19_spherical_geometry_spherical_coordinates(double *, double *); /*proto*/
static double __pyx_f_19_spherical_geometry_mod(double, double, int __pyx_skip_dispatch); /*proto*/
#define __Pyx_MODULE_NAME "_spherical_geometry"
extern int __pyx_module_is_main__spherical_geometry;
int __pyx_module_is_main__spherical_geometry = 0;

/* Implementation of '_spherical_geometry' */
...
static PyObject *__pyx_pf_19_spherical_geometry_mod(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_a, double __pyx_v_b); /* proto */
...
static void __pyx_f_19_spherical_geometry_cartesian_coordinates(double *__pyx_v_latlon, double *__pyx_v_result) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("cartesian_coordinates", 0);

  /* "_spherical_geometry.pyx":32
 *     [lat, lon] in radians
 *     """
 ...
 */
  (__pyx_v_result[0]) = (cos((__pyx_v_latlon[0])) * cos((__pyx_v_latlon[1])));

  /* "_spherical_geometry.pyx":33
 *     """
 *     result[0] = cos(latlon[0]) * cos(latlon[1])
 *     result[1] = cos(latlon[0]) * sin(latlon[1])             # <<<<<<<<<<<<<<
 *     result[2] = sin(latlon[0])
 * 
 */
  (__pyx_v_result[1]) = (cos((__pyx_v_latlon[0])) * sin((__pyx_v_latlon[1])));

  /* "_spherical_geometry.pyx":34
 *     result[0] = cos(latlon[0]) * cos(latlon[1])
 *     result[1] = cos(latlon[0]) * sin(latlon[1])
 *     result[2] = sin(latlon[0])             # <<<<<<<<<<<<<<
 * 
 * 
 */
  (__pyx_v_result[2]) = sin((__pyx_v_latlon[0]));
...
static void __pyx_f_19_spherical_geometry_spherical_coordinates(double *__pyx_v_xyz, double *__pyx_v_result) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("spherical_coordinates", 0);

  /* "_spherical_geometry.pyx":43
 *     cartesian coordinates: [x, y, z]
 *     """
 *     result[0] = asin(xyz[2])             # <<<<<<<<<<<<<<
 ...
 * 
 */
  (__pyx_v_result[0]) = asin((__pyx_v_xyz[2]));

  /* "_spherical_geometry.pyx":44
 *     """
 *     result[0] = asin(xyz[2])
 *     result[1] = atan2(xyz[1], xyz[0])             # <<<<<<<<<<<<<<
 * 
 * 
 */
  (__pyx_v_result[1]) = atan2((__pyx_v_xyz[1]), (__pyx_v_xyz[0]));
...
static void __pyx_f_19_spherical_geometry_gc_arc_midpoint(double *__pyx_v_latlon_1, double *__pyx_v_latlon_2, double *__pyx_v_midpoint) {
  double __pyx_v_norm;
  double __pyx_v_xyz_1[3];
  double __pyx_v_xyz_2[3];
  double __pyx_v_xyz_midpoint[3];
  __Pyx_RefNannyDeclarations
  double __pyx_t_1[3];
  double __pyx_t_2[3];
  __Pyx_RefNannySetupContext("gc_arc_midpoint", 0);

  /* "_spherical_geometry.pyx":56
 *     cdef double norm
 ...
 */
  __pyx_f_19_spherical_geometry_cartesian_coordinates(__pyx_v_latlon_1, __pyx_v_xyz_1);

  /* "_spherical_geometry.pyx":57
 *     cdef double[3] xyz_1, xyz_2, xyz_midpoint
 *     cartesian_coordinates(latlon_1, xyz_1)
 *     cartesian_coordinates(latlon_2, xyz_2)             # <<<<<<<<<<<<<<
 *     xyz_midpoint[:] = [ xyz_1[0]+xyz_2[0], xyz_1[1]+xyz_2[1], xyz_1[2]+xyz_2[2] ]
 ...
 */
  __pyx_f_19_spherical_geometry_cartesian_coordinates(__pyx_v_latlon_2, __pyx_v_xyz_2);

  /* "_spherical_geometry.pyx":58
 *     cartesian_coordinates(latlon_1, xyz_1)
 *     cartesian_coordinates(latlon_2, xyz_2)
 *     xyz_midpoint[:] = [ xyz_1[0]+xyz_2[0], xyz_1[1]+xyz_2[1], xyz_1[2]+xyz_2[2] ]             # <<<<<<<<<<<<<<
 *     norm = norm_3d(xyz_midpoint)
 ...
 */
  __pyx_t_1[0] = ((__pyx_v_xyz_1[0]) + (__pyx_v_xyz_2[0]));
  __pyx_t_1[1] = ((__pyx_v_xyz_1[1]) + (__pyx_v_xyz_2[1]));
  __pyx_t_1[2] = ((__pyx_v_xyz_1[2]) + (__pyx_v_xyz_2[2]));
  memcpy(&(__pyx_v_xyz_midpoint[0]), __pyx_t_1, sizeof(__pyx_v_xyz_midpoint[0]) * (3));

  /* "_spherical_geometry.pyx":59
 *     cartesian_coordinates(latlon_2, xyz_2)
 *     xyz_midpoint[:] = [ xyz_1[0]+xyz_2[0], xyz_1[1]+xyz_2[1], xyz_1[2]+xyz_2[2] ]
 *     norm = norm_3d(xyz_midpoint)             # <<<<<<<<<<<<<<
 *     xyz_midpoint[:] = [ xyz_midpoint[0]/norm, xyz_midpoint[1]/norm, xyz_midpoint[2]/norm ]
 ...
 */
  __pyx_v_norm = __pyx_f_5_math_norm_3d(__pyx_v_xyz_midpoint);

  /* "_spherical_geometry.pyx":60
 *     xyz_midpoint[:] = [ xyz_1[0]+xyz_2[0], xyz_1[1]+xyz_2[1], xyz_1[2]+xyz_2[2] ]
 *     norm = norm_3d(xyz_midpoint)
 *     xyz_midpoint[:] = [ xyz_midpoint[0]/norm, xyz_midpoint[1]/norm, xyz_midpoint[2]/norm ]             # <<<<<<<<<<<<<<
 *     spherical_coordinates(xyz_midpoint, midpoint)
 * 
 */
  __pyx_t_2[0] = ((__pyx_v_xyz_midpoint[0]) / __pyx_v_norm);
  __pyx_t_2[1] = ((__pyx_v_xyz_midpoint[1]) / __pyx_v_norm);
  __pyx_t_2[2] = ((__pyx_v_xyz_midpoint[2]) / __pyx_v_norm);
  memcpy(&(__pyx_v_xyz_midpoint[0]), __pyx_t_2, sizeof(__pyx_v_xyz_midpoint[0]) * (3));

  /* "_spherical_geometry.pyx":61
 *     norm = norm_3d(xyz_midpoint)
 *     xyz_midpoint[:] = [ xyz_midpoint[0]/norm, xyz_midpoint[1]/norm, xyz_midpoint[2]/norm ]
 *     spherical_coordinates(xyz_midpoint, midpoint)             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_f_19_spherical_geometry_spherical_coordinates(__pyx_v_xyz_midpoint, __pyx_v_midpoint);
...
static void __pyx_f_19_spherical_geometry_great_circle_plane(double *__pyx_v_r1, double *__pyx_v_r2, double *__pyx_v_params) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("great_circle_plane", 0);

  /* "_spherical_geometry.pyx":70
 *     Plane through r1, r2 (lat, lon in radians), and origin sphere
 *     """
 ...
 */
  (__pyx_v_params[0]) = (((cos((__pyx_v_r1[0])) * sin((__pyx_v_r2[0]))) * sin((__pyx_v_r1[1]))) - ((cos((__pyx_v_r2[0])) * sin((__pyx_v_r1[0]))) * sin((__pyx_v_r2[1]))));

  /* "_spherical_geometry.pyx":71
 *     """
 *     params[0] = cos(r1[0])*sin(r2[0])*sin(r1[1]) - cos(r2[0])*sin(r1[0])*sin(r2[1])
 *     params[1] = cos(r2[0])*sin(r1[0])*cos(r2[1]) - cos(r1[0])*sin(r2[0])*cos(r1[1])             # <<<<<<<<<<<<<<
 *     params[2] = cos(r1[0]) * cos(r2[0]) * sin(r2[1]-r1[1])
 * 
 */
  (__pyx_v_params[1]) = (((cos((__pyx_v_r2[0])) * sin((__pyx_v_r1[0]))) * cos((__pyx_v_r2[1]))) - ((cos((__pyx_v_r1[0])) * sin((__pyx_v_r2[0]))) * cos((__pyx_v_r1[1]))));

  /* "_spherical_geometry.pyx":72
 *     params[0] = cos(r1[0])*sin(r2[0])*sin(r1[1]) - cos(r2[0])*sin(r1[0])*sin(r2[1])
 *     params[1] = cos(r2[0])*sin(r1[0])*cos(r2[1]) - cos(r1[0])*sin(r2[0])*cos(r1[1])
 *     params[2] = cos(r1[0]) * cos(r2[0]) * sin(r2[1]-r1[1])             # <<<<<<<<<<<<<<
 * 
 * 
 */
  (__pyx_v_params[2]) = ((cos((__pyx_v_r1[0])) * cos((__pyx_v_r2[0]))) * sin(((__pyx_v_r2[1]) - (__pyx_v_r1[1]))));
...
static double __pyx_f_19_spherical_geometry_great_circle_distance(double *__pyx_v_latlon_1, double *__pyx_v_latlon_2) {
  double __pyx_v_lat1;
  double __pyx_v_lon1;
  double __pyx_v_lat2;
  double __pyx_v_lon2;
  ...
  double __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("great_circle_distance", 0);

  /* "_spherical_geometry.pyx":84
 ...
 */
  __pyx_v_lat1 = (__pyx_v_latlon_1[0]);

  /* "_spherical_geometry.pyx":85
 *     """
 *     cdef double lat1 = latlon_1[0]
 *     cdef double lon1 = latlon_1[1]             # <<<<<<<<<<<<<<
 *     cdef double lat2 = latlon_2[0]
 ...
 */
  __pyx_v_lon1 = (__pyx_v_latlon_1[1]);

  /* "_spherical_geometry.pyx":86
 *     cdef double lat1 = latlon_1[0]
 *     cdef double lon1 = latlon_1[1]
 *     cdef double lat2 = latlon_2[0]             # <<<<<<<<<<<<<<
 *     cdef double lon2 = latlon_2[1]
 ...
 */
  __pyx_v_lat2 = (__pyx_v_latlon_2[0]);

  /* "_spherical_geometry.pyx":87
 *     cdef double lon1 = latlon_1[1]
 *     cdef double lat2 = latlon_2[0]
 *     cdef double lon2 = latlon_2[1]             # <<<<<<<<<<<<<<
 *     cdef double dlon = lon1 - lon2
 ...
 */
  __pyx_v_lon2 = (__pyx_v_latlon_2[1]);

  /* "_spherical_geometry.pyx":88
 *     cdef double lat2 = latlon_2[0]
 *     cdef double lon2 = latlon_2[1]
 *     cdef double dlon = lon1 - lon2             # <<<<<<<<<<<<<<
 *     cdef double dlat = lat1 - lat2
 ...
 */
  __pyx_v_dlon = (__pyx_v_lon1 - __pyx_v_lon2);

  /* "_spherical_geometry.pyx":89
 *     cdef double lon2 = latlon_2[1]
 *     cdef double dlon = lon1 - lon2
 *     cdef double dlat = lat1 - lat2             # <<<<<<<<<<<<<<
 *     return 2*asin(sqrt((sin((dlat)/2))**2 + cos(lat1)*cos(lat2)*(sin((dlon)/2))**2))
 * 
 */
  __pyx_v_dlat = (__pyx_v_lat1 - __pyx_v_lat2);

  /* "_spherical_geometry.pyx":90
 *     cdef double dlon = lon1 - lon2
 *     cdef double dlat = lat1 - lat2
 *     return 2*asin(sqrt((sin((dlat)/2))**2 + cos(lat1)*cos(lat2)*(sin((dlon)/2))**2))             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_r = (2.0 * asin(sqrt((pow(sin((__pyx_v_dlat / 2.0)), 2.0) + ((cos(__pyx_v_lat1) * cos(__pyx_v_lat2)) * pow(sin((__pyx_v_dlon / 2.0)), 2.0))))));
  goto __pyx_L0;
...
static double __pyx_f_19_spherical_geometry_gc_meridian_intersection(double *__pyx_v_gc_plane, double __pyx_v_parallel1, double __pyx_v_parallel2, double __pyx_v_meridian) {
  double __pyx_v_a_12;
  double __pyx_v_b_12;
  double __pyx_v_c_12;
  double __pyx_v_lat_intersect;
  double __pyx_r;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  int __pyx_t_2;
  __Pyx_RefNannySetupContext("gc_meridian_intersection", 0);

  /* "_spherical_geometry.pyx":98
 * cdef double gc_meridian_intersection(double[3] gc_plane, double parallel1,
 *                                      double parallel2, double meridian):
 *     cdef double a_12 = gc_plane[0]             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v_a_12 = (__pyx_v_gc_plane[0]);

  /* "_spherical_geometry.pyx":99
 *                                      double parallel2, double meridian):
 *     cdef double a_12 = gc_plane[0]
 *     cdef double b_12 = gc_plane[1]             # <<<<<<<<<<<<<<
 *     cdef double c_12 = gc_plane[2]
 ...
 */
  __pyx_v_b_12 = (__pyx_v_gc_plane[1]);

  /* "_spherical_geometry.pyx":100
 *     cdef double a_12 = gc_plane[0]
 *     cdef double b_12 = gc_plane[1]
 *     cdef double c_12 = gc_plane[2]             # <<<<<<<<<<<<<<
 *     lat_intersect = -atan( a_12*cos(meridian)/c_12 + b_12*sin(meridian)/c_12 )
 ...
 */
  __pyx_v_c_12 = (__pyx_v_gc_plane[2]);

  /* "_spherical_geometry.pyx":101
 *     cdef double b_12 = gc_plane[1]
 *     cdef double c_12 = gc_plane[2]
 *     lat_intersect = -atan( a_12*cos(meridian)/c_12 + b_12*sin(meridian)/c_12 )             # <<<<<<<<<<<<<<
 *     if parallel1 <= lat_intersect <= parallel2:
 ...
 */
  __pyx_v_lat_intersect = (-atan((((__pyx_v_a_12 * cos(__pyx_v_meridian)) / __pyx_v_c_12) + ((__pyx_v_b_12 * sin(__pyx_v_meridian)) / __pyx_v_c_12))));

  /* "_spherical_geometry.pyx":102
 *     cdef double c_12 = gc_plane[2]
 *     lat_intersect = -atan( a_12*cos(meridian)/c_12 + b_12*sin(meridian)/c_12 )
 *     if parallel1 <= lat_intersect <= parallel2:             # <<<<<<<<<<<<<<
 *         return lat_intersect
 *     return 9999
 */
  __pyx_t_1 = (__pyx_v_parallel1 <= __pyx_v_lat_intersect);
  if (__pyx_t_1) {
    __pyx_t_1 = (__pyx_v_lat_intersect <= __pyx_v_parallel2);
  }
  __pyx_t_2 = (__pyx_t_1 != 0);
  if (__pyx_t_2) {

    /* "_spherical_geometry.pyx":103
 *     lat_intersect = -atan( a_12*cos(meridian)/c_12 + b_12*sin(meridian)/c_12 )
 *     if parallel1 <= lat_intersect <= parallel2:
 *         return lat_intersect             # <<<<<<<<<<<<<<
 *     return 9999
...
static void __pyx_f_19_spherical_geometry_gc_parallel_intersection(double *__pyx_v_r1, double *__pyx_v_r2, double __pyx_v_meridian1, double __pyx_v_meridian2, double __pyx_v_parallel, double *__pyx_v_lon_intersections) {
  double __pyx_v_lat1;
  double __pyx_v_lon1;
  double __pyx_v_lat2;
  double __pyx_v_lon2;
  ...
  double __pyx_v_b;
  double __pyx_v_c;
  double __pyx_v_ab_norm;
  double __pyx_v_lon;
  double __pyx_v_lon_intersection1;
  double __pyx_v_lon_intersection2;
  double __pyx_v_dlon;
  __Pyx_RefNannyDeclarations
  double __pyx_t_1[2];
  int __pyx_t_2;
  int __pyx_t_3;
  __Pyx_RefNannySetupContext("gc_parallel_intersection", 0);

  /* "_spherical_geometry.pyx":112
 * cdef void gc_parallel_intersection(double[2] r1, double[2] r2, double meridian1,
 *                                    double meridian2, double parallel, double[2] lon_intersections):
 *     lon_intersections[:] = [9999, 9999]             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_1[0] = 9999.0;
  __pyx_t_1[1] = 9999.0;
  memcpy(&(__pyx_v_lon_intersections[0]), __pyx_t_1, sizeof(__pyx_v_lon_intersections[0]) * (2));

  /* "_spherical_geometry.pyx":113
 *                                    double meridian2, double parallel, double[2] lon_intersections):
 *     lon_intersections[:] = [9999, 9999]
 *     cdef double lat1 = r1[0]             # <<<<<<<<<<<<<<
 *     cdef double lon1 = r1[1]
 ...
 */
  __pyx_v_lat1 = (__pyx_v_r1[0]);

  /* "_spherical_geometry.pyx":114
 *     lon_intersections[:] = [9999, 9999]
 *     cdef double lat1 = r1[0]
 *     cdef double lon1 = r1[1]             # <<<<<<<<<<<<<<
 *     cdef double lat2 = r2[0]
 ...
 */
  __pyx_v_lon1 = (__pyx_v_r1[1]);

  /* "_spherical_geometry.pyx":115
 *     cdef double lat1 = r1[0]
 *     cdef double lon1 = r1[1]
 *     cdef double lat2 = r2[0]             # <<<<<<<<<<<<<<
 *     cdef double lon2 = r2[1]
 ...
 */
  __pyx_v_lat2 = (__pyx_v_r2[0]);

  /* "_spherical_geometry.pyx":116
 *     cdef double lon1 = r1[1]
 *     cdef double lat2 = r2[0]
 *     cdef double lon2 = r2[1]             # <<<<<<<<<<<<<<
 *     cdef double l12 = lon1 - lon2
 ...
 */
  __pyx_v_lon2 = (__pyx_v_r2[1]);

  /* "_spherical_geometry.pyx":117
 *     cdef double lat2 = r2[0]
 *     cdef double lon2 = r2[1]
 *     cdef double l12 = lon1 - lon2             # <<<<<<<<<<<<<<
 *     cdef double a, b, c, ab_norm
 ...
 */
  __pyx_v_l12 = (__pyx_v_lon1 - __pyx_v_lon2);

  /* "_spherical_geometry.pyx":120
 *     cdef double a, b, c, ab_norm
 *     cdef double lon, lon_intersection1, lon_intersection2
 ...
 */
  __pyx_v_a = (((sin(__pyx_v_lat1) * cos(__pyx_v_lat2)) * cos(__pyx_v_parallel)) * sin(__pyx_v_l12));

  /* "_spherical_geometry.pyx":121
 *     cdef double lon, lon_intersection1, lon_intersection2
 *     a = sin(lat1)*cos(lat2)*cos(parallel)*sin(l12)
 *     b = sin(lat1)*cos(lat2)*cos(parallel)*cos(l12) - cos(lat1)*sin(lat2)*cos(parallel)             # <<<<<<<<<<<<<<
 *     c = cos(lat1)*cos(lat2)*sin(parallel)*sin(l12)
 *     lon = atan2(b, a)
 */
  __pyx_v_b = ((((sin(__pyx_v_lat1) * cos(__pyx_v_lat2)) * cos(__pyx_v_parallel)) * cos(__pyx_v_l12)) - ((cos(__pyx_v_lat1) * sin(__pyx_v_lat2)) * cos(__pyx_v_parallel)));

  /* "_spherical_geometry.pyx":122
 *     a = sin(lat1)*cos(lat2)*cos(parallel)*sin(l12)
 *     b = sin(lat1)*cos(lat2)*cos(parallel)*cos(l12) - cos(lat1)*sin(lat2)*cos(parallel)
 *     c = cos(lat1)*cos(lat2)*sin(parallel)*sin(l12)             # <<<<<<<<<<<<<<
 *     lon = atan2(b, a)
 ...
 */
  __pyx_v_c = (((cos(__pyx_v_lat1) * cos(__pyx_v_lat2)) * sin(__pyx_v_parallel)) * sin(__pyx_v_l12));

  /* "_spherical_geometry.pyx":123
 *     b = sin(lat1)*cos(lat2)*cos(parallel)*cos(l12) - cos(lat1)*sin(lat2)*cos(parallel)
 *     c = cos(lat1)*cos(lat2)*sin(parallel)*sin(l12)
 *     lon = atan2(b, a)             # <<<<<<<<<<<<<<
 *     ab_norm = sqrt(a**2 + b**2)
 *     if (fabs(c) > ab_norm):
 */
  __pyx_v_lon = atan2(__pyx_v_b, __pyx_v_a);

  /* "_spherical_geometry.pyx":124
 *     c = cos(lat1)*cos(lat2)*sin(parallel)*sin(l12)
 *     lon = atan2(b, a)
 *     ab_norm = sqrt(a**2 + b**2)             # <<<<<<<<<<<<<<
 *     if (fabs(c) > ab_norm):
 *         return
 */
  __pyx_v_ab_norm = sqrt((pow(__pyx_v_a, 2.0) + pow(__pyx_v_b, 2.0)));

  /* "_spherical_geometry.pyx":125
 *     lon = atan2(b, a)
 *     ab_norm = sqrt(a**2 + b**2)
 *     if (fabs(c) > ab_norm):             # <<<<<<<<<<<<<<
 *         return
 *     dlon = acos(c / ab_norm)
 */
  __pyx_t_2 = ((fabs(__pyx_v_c) > __pyx_v_ab_norm) != 0);
  if (__pyx_t_2) {

    /* "_spherical_geometry.pyx":126
 *     ab_norm = sqrt(a**2 + b**2)
 *     if (fabs(c) > ab_norm):
 *         return             # <<<<<<<<<<<<<<
 *     dlon = acos(c / ab_norm)
 ...
 */
  __pyx_v_dlon = acos((__pyx_v_c / __pyx_v_ab_norm));

  /* "_spherical_geometry.pyx":128
 *         return
 *     dlon = acos(c / ab_norm)
 *     lon_intersection1 = mod(lon1+dlon+lon+PI, TWOPI) - PI             # <<<<<<<<<<<<<<
 *     lon_intersection2 = mod(lon1-dlon+lon+PI, TWOPI) - PI
 ...
 */
  __pyx_v_lon_intersection1 = (__pyx_f_19_spherical_geometry_mod((((__pyx_v_lon1 + __pyx_v_dlon) + __pyx_v_lon) + M_PI), __pyx_v_19_spherical_geometry_TWOPI, 0) - M_PI);

  /* "_spherical_geometry.pyx":129
 *     dlon = acos(c / ab_norm)
 *     lon_intersection1 = mod(lon1+dlon+lon+PI, TWOPI) - PI
 *     lon_intersection2 = mod(lon1-dlon+lon+PI, TWOPI) - PI             # <<<<<<<<<<<<<<
 *     if meridian1 <= lon_intersection1 <= meridian2:
 ...
 */
  __pyx_v_lon_intersection2 = (__pyx_f_19_spherical_geometry_mod((((__pyx_v_lon1 - __pyx_v_dlon) + __pyx_v_lon) + M_PI), __pyx_v_19_spherical_geometry_TWOPI, 0) - M_PI);

  /* "_spherical_geometry.pyx":130
 *     lon_intersection1 = mod(lon1+dlon+lon+PI, TWOPI) - PI
 *     lon_intersection2 = mod(lon1-dlon+lon+PI, TWOPI) - PI
 *     if meridian1 <= lon_intersection1 <= meridian2:             # <<<<<<<<<<<<<<
 *         lon_intersections[0] = lon_intersection1
 ...
 */
  __pyx_t_2 = (__pyx_v_meridian1 <= __pyx_v_lon_intersection1);
  if (__pyx_t_2) {
    __pyx_t_2 = (__pyx_v_lon_intersection1 <= __pyx_v_meridian2);
  }
  __pyx_t_3 = (__pyx_t_2 != 0);
  if (__pyx_t_3) {

    /* "_spherical_geometry.pyx":131
 *     lon_intersection2 = mod(lon1-dlon+lon+PI, TWOPI) - PI
 *     if meridian1 <= lon_intersection1 <= meridian2:
 *         lon_intersections[0] = lon_intersection1             # <<<<<<<<<<<<<<
 *     if meridian1 <= lon_intersection2 <= meridian2:
 ...
 */
    (__pyx_v_lon_intersections[0]) = __pyx_v_lon_intersection1;
 ...
 * 
 */
  __pyx_t_3 = (__pyx_v_meridian1 <= __pyx_v_lon_intersection2);
  if (__pyx_t_3) {
    __pyx_t_3 = (__pyx_v_lon_intersection2 <= __pyx_v_meridian2);
  }
  __pyx_t_2 = (__pyx_t_3 != 0);
  if (__pyx_t_2) {

    /* "_spherical_geometry.pyx":133
 *         lon_intersections[0] = lon_intersection1
 *     if meridian1 <= lon_intersection2 <= meridian2:
 *         lon_intersections[1] = lon_intersection2             # <<<<<<<<<<<<<<
 * 
 * 
 */
    (__pyx_v_lon_intersections[1]) = __pyx_v_lon_intersection2;
...
static PyObject *__pyx_pw_19_spherical_geometry_1mod(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static double __pyx_f_19_spherical_geometry_mod(double __pyx_v_a, double __pyx_v_b, CYTHON_UNUSED int __pyx_skip_dispatch) {
  double __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("mod", 0);

  /* "_spherical_geometry.pyx":137
 * 
 * cpdef double mod(double a, double b):
 *     return a % b             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_r = __Pyx_mod_double(__pyx_v_a, __pyx_v_b);
  goto __pyx_L0;
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("_spherical_geometry.mod", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_19_spherical_geometry_1mod(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_19_spherical_geometry_1mod(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  double __pyx_v_a;
  double __pyx_v_b;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("mod (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_b)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("mod", 1, 2, 2, 1); __PYX_ERR(0, 136, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "mod") < 0)) __PYX_ERR(0, 136, __pyx_L3_error)
      }
    ...
    __pyx_v_a = __pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_a == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 136, __pyx_L3_error)
    __pyx_v_b = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_b == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 136, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("mod", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 136, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("_spherical_geometry.mod", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_19_spherical_geometry_mod(__pyx_self, __pyx_v_a, __pyx_v_b);
...
static PyObject *__pyx_pf_19_spherical_geometry_mod(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_a, double __pyx_v_b) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("mod", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_19_spherical_geometry_mod(__pyx_v_a, __pyx_v_b, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 136, __pyx_L1_error)
...
static PyMethodDef __pyx_methods[] = {
  {"mod", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_19_spherical_geometry_1mod, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec__spherical_geometry(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec__spherical_geometry},
  {0, NULL}
};
#endif
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("cartesian_coordinates", (void (*)(void))__pyx_f_19_spherical_geometry_cartesian_coordinates, "void (double *, double *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("spherical_coordinates", (void (*)(void))__pyx_f_19_spherical_geometry_spherical_coordinates, "void (double *, double *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("gc_arc_midpoint", (void (*)(void))__pyx_f_19_spherical_geometry_gc_arc_midpoint, "void (double *, double *, double *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("great_circle_plane", (void (*)(void))__pyx_f_19_spherical_geometry_great_circle_plane, "void (double *, double *, double *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("great_circle_distance", (void (*)(void))__pyx_f_19_spherical_geometry_great_circle_distance, "double (double *, double *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("gc_meridian_intersection", (void (*)(void))__pyx_f_19_spherical_geometry_gc_meridian_intersection, "double (double *, double, double, double)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("gc_parallel_intersection", (void (*)(void))__pyx_f_19_spherical_geometry_gc_parallel_intersection, "void (double *, double *, double, double, double, double *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __Pyx_modinit_function_import_code(void) {
  ...
  __pyx_t_1 = PyImport_ImportModule("_math"); if (!__pyx_t_1) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_1, "radians", (void (**)(void))&__pyx_f_5_math_radians, "double (double)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_1, "degrees", (void (**)(void))&__pyx_f_5_math_degrees, "double (double)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_1, "cross_product_3d", (void (**)(void))&__pyx_f_5_math_cross_product_3d, "void (double *, double *, double *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_1, "norm_3d", (void (**)(void))&__pyx_f_5_math_norm_3d, "double (double *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_spherical_geometry(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC init_spherical_geometry(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__spherical_geometry(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__spherical_geometry(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec__spherical_geometry(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module '_spherical_geometry' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit__spherical_geometry(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_spherical_geometry", __pyx_methods, __pyx_k_author_Fabrizio_Magrini_email1, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main__spherical_geometry) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "_spherical_geometry")) {
      if (unlikely(PyDict_SetItemString(modules, "_spherical_geometry", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 * 
 */
  __pyx_v_19_spherical_geometry_TWOPI = (2.0 * M_PI);

  /* "_spherical_geometry.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init _spherical_geometry", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init _spherical_geometry");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
